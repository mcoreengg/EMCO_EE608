...
# 738 "./mcc_generated_files/system/pins.h"
...
void display(void) {
  ...
  LATD = 0;
  LATBbits.LATB7 = LATAbits.LATA7 = LATAbits.LATA6 = 0;



  if(n<=7){
    do { LATCbits.LATC5 = 0; } while(0);
    if((n & 0x04)>>2)do { LATBbits.LATB7 = 1; } while(0);
    if((n & 0x02)>>1)do { LATAbits.LATA7 = 1; } while(0);
    if((n & 0x01))do { LATAbits.LATA6 = 1; } while(0);
  }
  if(n==8){
...
void format_data_to_display(uint8_t bcdval, uint32_t counterval)
{
    ...
    digitval[1] = bcdval/10;
    digitval[0] = bcdval%10;
